...
\begin{sloppypar}
  ...
  Similarly, you may take for granted that the following equation is true:
...
which shows us that
$$A = \frac{L}{2m} T ,$$
or in Lagrange's notation,
$$A(t) = \frac{L}{2m} t .$$
This shows us a directly proportional relationship between the area $A$ and time $T$. Note that $\frac{L}{2m}$ is constant.
